...
(doom! :input
       ...
       (:if (string-equal-ignore-case (system-name) "dinm5CG52813LW") format (format +onsave))              ; automated prettiness
       ...
       (lsp +booster +eglot) ;+peek)         ; M-x vscode
       ...
       (org +dragndrop +gnuplot
            +pretty +roam) ; organize your plain life in plain text
