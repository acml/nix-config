      ...
      (
        let
          ...
          src = pkgs.fetchFromGitHub {
            owner = "dakra";
            repo = "ghostel";
            rev = "4343d948e43aed260d8ec42927b769d85fd0c2ec";
            hash = "sha256-ZAFMd7VM5GiMG7ehjJo7G1M+9dYOkYKl38jm6r9l+YM=";
          };
    ...
    ++ lib.optionals isLinux [
      (melpaBuild {
        ...
        src = pkgs.fetchFromGitea {
          ...
          owner = "divyaranjan";
          repo = "emacs-reader";
          rev = "7792885f28"; # replace with 'version' for stable
          hash = "sha256-3jkbEUOXOlKIMTBihEUWgF9+nq7tnYWGO449H7XM9vQ=";
        };
